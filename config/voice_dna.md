...
**Who I am:** I'm the CEO and co-founder of BriteCo, an insurtech building a portfolio of niche, highly profitable specialty insurance products — jewelry, watch, wedding — with a rinse-and-repeat model designed to own underserved verticals and cross-sell across a growing policyholder base. I stand for execution over narrative, empathy over ego, and the belief that the best businesses are built on genuine domain expertise — mine being that of a third-generation jeweler and GIA gemologist, which gives me credibility most insurtech founders simply can't manufacture. What makes my perspective different is that I sit at a rare intersection: deep technical knowledge of the products I'm insuring, the regulatory fluency of an insurance operator, and the growth instincts of a tech-forward founder — and I'm allergic to the consultant class that talks without building. The people I work with — carriers, investors, jeweler partners, policyholders — get someone who's direct, accountable, and genuinely invested in outcomes, not optics.

**My preferred words:** Build. Execute. Real. Material. Niche. Own. Grow. Polish. Genuine. Direct. Empathy. Actionable. Awareness. Culture. Footprint. Specific. Profitable. Rinse and repeat. Credibility. Outcomes.

**My signature structures:**
1. Lead with the point, then back it up. I don't warm up. I state the thesis or conclusion first, then build the case behind it with data, context, or examples. I never make someone read to the bottom to find out what I actually think.
2. Problem → Insight → Action. Almost everything I write follows this arc: here's what's happening, here's what it means, here's what we do about it. Even short emails. The action at the end is non-negotiable — if there's no "so what," it shouldn't exist.
3. Close with clarity, not summary. I don't recap. I close by telling the reader exactly what happens next — a decision that needs to be made, a step to take, a question to answer. The last sentence is always forward-facing.

**My topics & opinions:** I'm the CEO and co-founder of BriteCo, building a portfolio of niche, highly profitable specialty insurance products — jewelry, watch, wedding and beyond — with a rinse-and-repeat model that owns underserved verticals and cross-sells across a growing policyholder base. I'm a third-generation jeweler and GIA gemologist, which gives me credibility most insurtech founders can't manufacture, and I sit at a rare intersection of deep product knowledge, regulatory fluency, and growth instincts. I write about building products, distribution, paid media, competitive intelligence, and the unglamorous operational reality of running an insurtech — and I lead with the point, back it up with real data, and always close with what happens next. I believe execution beats strategy on paper, empathy beats ego, niche beats broad, and that domain expertise is the only moat worth building — and I'm allergic to consultants who talk without building, content that could've been written by anyone, and anything that looks like AI wrote it.
